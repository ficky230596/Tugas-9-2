...
app = Flask(__name__)
password = "mario"
cxn_str = f"mongodb+srv://Basilius:{password}@cluster01.biqbzlj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster01"
client = MongoClient(cxn_str)
db = client.ficky_test2

@app.route('/')
def main():
    words_result = db.ficky.find({}, {'_id': False})
    words = []
